...
#f1 ikisinin harmonik ortalaması
        ...
        if layers == 1:
              ...
              model = keras.Sequential([
                    keras.layers.Dense(first_number,input_dim=21, activation=act_func1),
        ...
        MLP = model.fit(X_train, y_train,epochs=epoch_num,validation_split=Cv)
...
tk.Button(window, text='Browse Train Set', command=import_data).place(x=215,y=50)
...
button = tk.Button(window, text = "Save", activebackground = "blue",
                      ...
                      command = buttonFunction2).place(x= 700,y=700)
...
tk.Radiobutton(window, text = "Linear", value = "linear",variable = svm_kernel).place(x=515, y= 70)
tk.Radiobutton(window, text = "RBF", value = "rbf", variable = svm_kernel).place(x= 515, y= 95)
tk.Radiobutton(window, text = "Polynomial", value = "poly",variable = svm_kernel).place(x= 515, y= 120)
tk.Radiobutton(window, text = "Sigmoid", value = "sigmoid", variable = svm_kernel).place(x= 515, y= 145)
...
tk.Radiobutton(window, text = "Cross Validation:", value = 1,variable = cross_random).place(x=15, y= 320)
tk.Radiobutton(window, text = "Random Percent:", value = 2, variable = cross_random).place(x= 15, y= 370)
...
tk.Radiobutton(window, text = "1", value = 1,variable = mlp_layers).place(x=15, y= 495)
tk.Radiobutton(window, text = "2", value = 2, variable = mlp_layers).place(x= 65, y= 495)
tk.Radiobutton(window, text = "3", value = 3,variable = mlp_layers).place(x= 115, y= 495)
...
label_act = tk.Label(window, text = "Activation Funcctions:")
